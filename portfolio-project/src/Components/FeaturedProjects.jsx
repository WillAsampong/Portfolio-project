...
const FeaturedProjects = () => {
  return (
    <section className="h-[500px] bg-[#FBFBFB] dark:bg-[#1E1E1E]" id="projects">
        <div className="w-4/5 mx-auto ">
            ...
            <div>
                <p className="font-bold text-3xl md:text-5xl text-center mt-20 dark:text-white">New projects coming soon...</p>
            </div>
        </div>
    </section>
  )
